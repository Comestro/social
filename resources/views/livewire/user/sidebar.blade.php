<div class="space-y-8">
    ...
    <div class="flex items-center gap-3 px-2">
        ...
        <div>
            <div class="font-bold text-slate-800">{{ auth()->user()->fname }} {{ auth()->user()->lname }}</div>
    ...
    <div>
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('find.friends') }}" class="flex items-center gap-3 px-3 py-2 text-slate-600 rounded-xl hover:bg-white hover:shadow-sm hover:text-indigo-600 transition group">
    ...
    <div>
        ...
        <nav class="space-y-1">
            <a href="#" class="flex items-center gap-3 px-3 py-2 text-slate-600 rounded-xl hover:bg-white hover:shadow-sm transition group">
                <img src="https://ui-avatars.com/api/?name=CS+101&background=random" class="w-8 h-8 rounded-lg object-cover">
                <span class="font-medium">CS 101 Study Group</span>
            </a>
            <a href="#" class="flex items-center gap-3 px-3 py-2 text-slate-600 rounded-xl hover:bg-white hover:shadow-sm transition group">
                <img src="https://ui-avatars.com/api/?name=Chess+Club&background=random" class="w-8 h-8 rounded-lg object-cover">
